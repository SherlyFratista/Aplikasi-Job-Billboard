...
<body>
	<div class="container-fluid">
		<div class="row" style="height: 710px">
			<div class="col-md-4" style="background-color: red; padding: 0">
				<img src="images/showcase_regist.jpg" class="img-fluid">
			</div>
			<div class="col-md-8" style="; background-image: url('images/logo.jpg'); background-size: 200px">
				<div class="container" style="background-color: #fff; width: 45%; padding: 20px 40px; margin-top: 60px">
					<form class="needs-validation" action="" method="">
						<div align="center" style="margin: 20px 0px 30px 0px">
							<label><h2><strong><a class="nav-link text-dark" href="index.html">JobBillboard</a></strong></h2></label>
						</div>
						<div class="form-group">
							<input class="form-control" type="text" name="firstName" placeholder="First Name" required></input>
						</div>
						<div class="form-group">
							<input class="form-control" type="text" name="lastName" placeholder="Last Name" required></input>
						</div>
						<div class="form-group">
							<input class="form-control" type="email" name="mail" placeholder="Email" required></input>
						</div>
						<div class="form-group">
							<input class="form-control" type="text" name="userName" placeholder="Username" required></input>
						</div>
						<div class="form-group">
							<input class="form-control" type="text" name="pwd" placeholder="Password" required></input>
						</div>
						<div class="row">
						...
						<div class="form-group">
							<input class="btn btn-primary" type="submit" value="Next" style="width: 100%">
						</div>
						<div align="center">
							<label>Have an account? <a href="loginJOB.php"><strong>Log in</strong></a></label>
						</div>
					</form>
				</div>
			</div>
	...
	<footer style="background-color: #f9dc24">
		<div class="container-fluid text-center text-md-left">
			<div class="row" style="height: 250px; background-color: #2c292f">
				<div class="col-md-4">
					<div class="container">
