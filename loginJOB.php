  ...
  <div class="container-fluid">
    <div class="row" style="height: 710px">
      ...
      <div class="col-md-8" style="; background-image: url('images/logo.jpg'); background-size: 200px">
        <div class="container" style="background-color: #fff; width: 45%; padding: 20px 40px; margin-top: 150px">
          <form class="needs-validation" action="" method="">
            ...
            <div class="form-group">
              <input class="form-control" type="password" name="pwd" placeholder="Password" required></input>
            </div>
            <div class="form-group">
              <input class="btn btn-primary" type="submit" value="Log In" style="width: 100%">
            </div>
            <div align="center">
              <label>Dont't have an account? <a href="form_register.html"><strong>Sign Up</strong></a></label>
            </div>
          </form>
        </div>
      </div>
